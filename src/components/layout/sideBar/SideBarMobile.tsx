...
export default function SideBarMobile() {
  ...
  return (
    <Modal onClick={closeMobileNav}>
      <nav
        onClick={closeMobileNav}
        className={`flex py-14 fixed left-0 top-0 ${preferredTheme} w-max h-lvh transition-all delay-200 duration-300 shadow-md rounded-r z-50 overflow-hidden`}>
        <section className='flex flex-col justify-around'>
          ...
          <main className='flex flex-col w-full gap-4'>
            <NavLink
              to='/'
              className='flex gap-6 items-center px-8 tablet:px-20 py-4 hover:bg-hover hover:text-white cursor-pointer'>
              <svg
              ...
              <h4 className='text-text text-sm'>Home</h4>
            </NavLink>
            ...
            <NavLink
              ...
              <h4 className='text-text text-sm'>Profile</h4>
            </NavLink>
            ...
            <NavLink
              ...
              <h4 className='text-text text-sm'>Services</h4>
            </NavLink>
            ...
            <NavLink
              ...
              <h4 className='text-text text-sm w-fukk'>About Us</h4>
            </NavLink>
            <NavLink
              to='/faq'
              className='flex gap-6 items-center px-8 tablet:px-20 py-4 hover:bg-hover hover:text-white cursor-pointer'>
              ...
              <h4 className='text-text text-sm w-16'>FAQ</h4>
            </NavLink>
          </main>
          ...
          <div>
            <Link
              to='/edit-profile'
              className='flex gap-6 items-center px-8 tablet:px-20 py-2'>
